...
{
	/// <summary>
	/// Stored information about a device in OneSignal app.
	/// View <see cref="!:https://documentation.onesignal.com/reference#view-device">API Documentation</see> for more info.
	/// </summary>
	public class DeviceViewResult
	{
		...
		/// <summary>
		/// Is the user able to receive notifications?
		/// </summary>
